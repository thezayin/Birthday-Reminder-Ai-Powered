...
class AppOpenAdManagerImpl : AppOpenAdManager {
    ...
    private val adId: String = "ca-app-pub-2913057115284606/7168466004"
     ...
     */
    override fun loadAd(activity: Activity, analytics: Analytics) {
                ...
                object : AppOpenAd.AppOpenAdLoadCallback() { // Callback for handling load result
                    ...
                    override fun onAdFailedToLoad(loadAdError: LoadAdError) {
                        ...
                        Timber.tag("AppOpenAd")
                            .d("App Open Ad failed to load: ${loadAdError}")
     ...
     */
    override fun showAd(
        analytics: Analytics, // Analytics instance for tracking ad events
