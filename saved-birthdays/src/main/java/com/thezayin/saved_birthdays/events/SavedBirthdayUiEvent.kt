...
sealed class SavedBirthdayUiEvent {
    ...
    data class DeleteSuccess(val message: String = "Birthday deleted successfully") :
        SavedBirthdayUiEvent()

    data class UpdateSuccess(val message: String = "Birthday updated successfully") :
        SavedBirthdayUiEvent()
