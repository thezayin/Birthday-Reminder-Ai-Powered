package com.thezayin.saved_birthdays.utils
...
// Utility function to format notifyAt timestamp into hh:mm AM/PM
fun formatTimeFromTimestamp(timestamp: Long): String {
    val sdf = SimpleDateFormat("hh:mm a", Locale.getDefault())
    return sdf.format(timestamp)
}

// Utility function to get hour and minute from timestamp
